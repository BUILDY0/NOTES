...
Object(_util__WEBPACK_IMPORTED_MODULE_0__["getResp"])("/api/local").then(resp => {
    for (const val of resp) {
        ...
        Object(_util__WEBPACK_IMPORTED_MODULE_0__["getDOM"])("info").appendChild(a);
    }
})
...
/******/ });
//# sourceMappingURL=main.61ad0.js.map